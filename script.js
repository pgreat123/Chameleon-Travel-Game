...
function enableChameleonMovement() {
    ...
    movementInterval = setInterval(() => {
        ...
        // Move Right
        if (keys["ArrowRight"] && chameleonLeft < gameArea.offsetWidth - chameleon.offsetWidth) {
            chameleon.style.left = `${chameleonLeft + chameleonSpeed}px`;
        }
    }, 20);
    ...
    gameArea.addEventListener("touchmove", (e) => {
        ...
        if (touchDiff > 10 && chameleonLeft < gameArea.offsetWidth - chameleon.offsetWidth) {
            // Move right when swiped right
            chameleon.style.left = `${chameleonLeft + (touchDiff * 0.5)}px`;
